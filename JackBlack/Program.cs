...
namespace JackBlack
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            //}
            PlayerDraw PDrawfunc = new PlayerDraw();
            PlayerDraw HDrawfunc = new PlayerDraw();
            List<Card> PHand = PDrawfunc.playerhand();
            List<Card> HHand = HDrawfunc.househand();
            _21 gamestart = new _21();
            gamestart.initialphase(true);
